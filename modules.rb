module Modules
  ...
  def register_user
    ...
    @driver.find_element(:id, 'user_lastname').send_keys 'last_n'
  ...
  def create_new_product_version
    ...
    @driver.find_element(:id, 'tab-content-versions').find_element(:css, "a[class='icon icon-add']").click
  ...
  def issue_feature
    ...
    @wait.until {@driver.find_element(:css, "option[value='2']").displayed?}
  ...
  def issue_support
    ...
    @wait.until {@driver.find_element(:css, "option[value='3']").displayed?}
